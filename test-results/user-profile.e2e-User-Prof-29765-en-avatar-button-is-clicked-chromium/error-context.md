...
- Name: user-profile.e2e.test.ts >> User Profile Integration Tests >> 2. Profile modal should open when avatar button is clicked
- Location: e2e\tests\user-profile.e2e.test.ts:95:7
